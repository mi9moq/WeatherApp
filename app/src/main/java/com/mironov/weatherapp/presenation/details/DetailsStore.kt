...
import com.mironov.weatherapp.domain.usecase.GetForecastUseCase
import com.mironov.weatherapp.domain.usecase.ObserveFavouriteStateUseCase
                ...
                Intent.ClickChangeFavouriteStatus -> {
                    scope.launch {
                        ...
                        if (state.isFavourite) {
                            changeFavoriteStateUseCase.remove(state.city.id)

                        } else {
                            changeFavoriteStateUseCase.add(state.city)
        ...
        override fun State.reduce(msg: Msg): State =
            when (msg) {
                ...
                is Msg.ForecastLoaded -> {
                    copy(forecastState = State.ForecastState.Content(msg.forecast))
                }
