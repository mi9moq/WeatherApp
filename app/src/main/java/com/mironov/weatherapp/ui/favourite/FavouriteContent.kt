package com.mironov.weatherapp.ui.favourite
...
import com.mironov.weatherapp.presenation.favourite.FavouriteStore
import com.mironov.weatherapp.ui.extesions.tempToFormattedString
import com.mironov.weatherapp.ui.theme.CardGradients
import com.mironov.weatherapp.ui.theme.Gradient
import com.mironov.weatherapp.ui.theme.Orange
...
fun BoxScope.ApplyLoadedState(
    ...
    Text(
        ...
        text = temp.tempToFormattedString(),
        color = MaterialTheme.colorScheme.background,
...
@Composable
fun BoxScope.ApplyLoadingState() {
